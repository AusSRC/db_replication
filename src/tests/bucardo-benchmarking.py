...
class TestReplicationBenchmarking(unittest.TestCase):
    ...
    def run_insert_wallaby_products(self, sequence):
        ...
        # Build batch sentences
        self.bu.buildBatch(nrows=id_sync, table = "wallaby.products", operation = "insert")
    
        # Get batch sentences
        content = self.bu.getBatch(nrows=id_sync, table = "wallaby.products", operation = "insert")    
        ...
        self.bu.addStats(row=result, nrows=id_sync, operation=operation, table="wallaby.products")
    ...
    def run_delete_wallaby_products(self,sequence):
        """ Generic delete function.
        Check tables templates to add new tables to insert data following a schema.
        """
        ...
        # Build batch sentences
        self.bu.buildBatch(nrows=id_sync, table = "wallaby.products", operation = "delete")
    
        # Get batch sentences
        content = self.bu.getBatch(nrows=id_sync, table = "wallaby.products", operation = "delete")    
